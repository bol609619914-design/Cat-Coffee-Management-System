    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/marketing/points/**").hasAuthority("points:read")
                        .requestMatchers(HttpMethod.GET, "/api/v1/marketing/coupons/**").hasAuthority("coupon:read")
                        .requestMatchers(HttpMethod.POST, "/api/v1/marketing/coupons/**").hasAuthority("coupon:write")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/marketing/coupons/**").hasAuthority("coupon:write")
                        .requestMatchers(HttpMethod.GET, "/api/v1/marketing/reviews/**").hasAuthority("review:read")
                        .requestMatchers(HttpMethod.POST, "/api/v1/marketing/reviews/**").hasAuthority("review:write")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/marketing/reviews/**").hasAuthority("review:write")
                        .requestMatchers(HttpMethod.GET, "/api/v1/marketing/activities/**").hasAuthority("activity:read")
                        .requestMatchers(HttpMethod.POST, "/api/v1/marketing/activities/**").hasAuthority("activity:write")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/marketing/activities/**").hasAuthority("activity:write")
